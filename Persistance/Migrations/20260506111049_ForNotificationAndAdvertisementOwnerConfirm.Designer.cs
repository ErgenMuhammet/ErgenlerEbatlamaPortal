...
namespace Persistence.Migrations
{
    ...
    [Migration("20260506111049_ForNotificationAndAdvertisementOwnerConfirm")]
    partial class ForNotificationAndAdvertisementOwnerConfirm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entitiy.Advertisements", b =>
                {
                    ...
                    b.Property<string>("AdvertisementAddress")
                        .IsRequired()
                        .HasMaxLength(250)
                    ...
                    b.HasIndex("AdvertisementAddress", "OwnerId", "Title")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entitiy.ChatMessage", b =>
                {
                    b.HasOne("Domain.Entitiy.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entitiy.AppUser", "Sender")
                        .WithMany()
